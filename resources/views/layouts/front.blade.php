            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> Nonton Video </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('kelas') }}">Video</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('podcast') }}">Trailer</a>
                                </li>
            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="single-footer-widget footer_1">
                        <a href="index.html"> <b>
                                <h2>Nonton Video Online</h2>
                            </b></a>
                        <p>Aplikasi nonton online nomor 1 di Indonesia</p>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-sm-6 col-md-4">
                    <div class="single-footer-widget footer_2">
                        ...
                        <div class="contact_info">
                            ...
                            <p><span> Phone :</span> +62 8123 1360 993</p>
                            <p><span> Email : </span>nontononline@gmail.com </p>
                        </div>
                    </div>
                </div>
            </div>
